...
class DailyDigestTests(unittest.TestCase):
    def test_keeps_only_highest_breakout_for_each_player(self):
        entries = [
            {"sport": "nfl", "player_name": "Jared Goff", "message": "BREAKOUT: Jared Goff"},
            {"sport": "nfl", "player_name": "Jared Goff", "message": "DOUBLE BREAKOUT: Jared Goff"},
        ...
        self.assertIn("Jared Goff — DOUBLE BREAKOUT", digest)
